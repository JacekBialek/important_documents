...
fig_quantities3<-ggplot(df3, aes(x=quantities)) + geom_histogram(color="black", fill="grey", bins=18)+labs(title="COICOP 6 (instant coffee)",x="number of products sold (in thousands)", y = "number of product IDs")
